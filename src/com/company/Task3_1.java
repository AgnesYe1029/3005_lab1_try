...
public class Task3_1 {
    ...
    public Task3_1(Map<int[],Double> distMap, Map<int[],Integer> energyMap) {
    ...
    public Task3_1(Map<int[],Double> distMap, Map<int[],Integer> energyMap,Map<Integer, List<Integer>> coordMap, double weight) {
        this.distMap = constructMap(distMap);
        this.energyMap = constructMap(energyMap);
    ...
    public static double AStarCal(double distCost,List<Integer> nodeCoord ,int goal, double weight){
        ...
        return distCost + weight * euclideanDist;
    }
}
